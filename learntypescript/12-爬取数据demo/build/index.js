...
var Reptile = /** @class */ (function () {
    function Reptile() {
        //请求（抓取）的url
        this.url = 'http://learning.sohu.com/?spm=smpc.news-home.header.7.15807126479731vt4ITG';
        //存储目录的文件路径
        this.filePath = path_1.default.resolve(__dirname, '../data/data.json');
        this.init();
    }
    //请求url获取到的内容
    Reptile.prototype.getHtml = function () {
    ...
    //获取的到内容，放入到对象
    Reptile.prototype.getJsonInfo = function (html) {
        var $ = cheerio_1.default.load(html);
        var item = $(".z-c-block-list-item");
        var titleArr = [];
    ...
    //存入到目录（判断：当前目录有没有？）
    Reptile.prototype.getNewContent = function (jsonInfo) {
        var fileContent = {};
    ...
    //写入内容
    Reptile.prototype.writeFile = function (fileContent) {
        fs_1.default.writeFileSync(this.filePath, fileContent);
    };
    //运行所有的项目方法
    Reptile.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
